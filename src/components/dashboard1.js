...
function Dashboard1(){
  const handleProfileClick = () => {
    ...
    window.location.href = '/lawyerprofile';
  };
    ...
    <div>
      ...
      <div className="container">
          <div className="sidebar">
            <h3><i className="fa-solid fa-table-columns" /> Dashboard</h3>
            <ul>
          ...
          <div className="content">
            ...
            <div className="case-board" title="Case Board">
              ...
              <button onClick={handleCaseClick}>Manage Cases</button>
